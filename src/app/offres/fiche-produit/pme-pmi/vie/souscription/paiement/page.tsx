  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-4">
        <Link href="/offres/fiche-produit/pme-pmi/vie/souscription/documents" className={cn(buttonVariants({ variant: "secondary" }))}>Précédent</Link>
        <button
          type="button"
          disabled={!canPay}
          onClick={() => {
