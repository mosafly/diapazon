...
export default function VieTableauPage() {
  return (
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="space-y-2 lg:col-span-3">
            ...
            <select className="mt-1 h-10 w-full rounded-md border border-border bg-background px-3 text-sm max-w-md">
              {["Décès Collectif", "Épargne Collective", "Frais Funéraires"].map((p) => (
          ...
          <Card className="lg:col-span-3">
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {[
                    { g: "Décès", m: "5 000 000", f: "Néant", b: "Forfait" },
                    { g: "Invalidité", m: "3 000 000", f: "Néant", b: "Forfait" },
                    { g: "Frais Funéraires", m: "500 000", f: "Néant", b: "Forfait" },
                  ].map((r) => (
                    <TableRow key={r.g}>
          ...
          <Card className="lg:col-span-3">
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {[
                    { g: "Décès", m: "10 000 000", f: "Néant", b: "Forfait" },
                    { g: "Invalidité", m: "6 000 000", f: "Néant", b: "Forfait" },
                    { g: "Frais Funéraires", m: "1 000 000", f: "Néant", b: "Forfait" },
                  ].map((r) => (
                    <TableRow key={r.g}>
                      <TableCell>{r.g}</TableCell>
                      <TableCell>{r.m}</TableCell>
